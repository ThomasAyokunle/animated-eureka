    ...
    if not sheet_url or not gemini_key:
        ...
        with st.spinner("Loading data from Google Sheet..."):
            try:
                ...
                # Use Google Sheets API v4 to get data
                # First, try to get all sheets info to find the right gid
                ...
                # Export as CSV with the correct gid
                ...
                st.write(df.columns.tolist()[:20])  # Show first 20 columns
                ...
                for col_idx in range(2, len(df.columns)):
                    ...
                    # Check if column name matches format like "March-2026" or contains year
...
Make sure forecast array has exactly 12 months. Return only valid JSON, no other text."""
                ...
                st.info("Make sure:\n1. Your sheet is shared (publicly or with anyone)\n2. The sheet tab name is correct\n3. Your data starts from column C")
